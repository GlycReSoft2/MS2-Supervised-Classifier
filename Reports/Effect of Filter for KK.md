...
errorTable <- name_rows(as.data.frame(rbind(checkMatch,checkFilt, checkRep)))
...
## 2          148             2             6          385 0.005168 3.492e-05
## 3          133            26            21          361 0.067183 5.049e-04
##   ErrorRate .numYes .numNo  .rownames
## 1   0.01109     154    387 checkMatch
## 2   0.01479     154    387  checkFilt
## 3   0.08688     154    387   checkRep
```
